...
class QCB:
    def __init__(self, height, width, io_width, reg, *msfs_templates):
        ...
        # reducing variables
        self.grid_segments: 'Set[Segment]' = set()
    ...
    def prune_invalid_edges(self, seg: Segment):
        ...
        elif seg.state.state == SCPatch.MSF:
    ...
    def prune_edges(self, seg: Segment):
        if seg.state.state in {SCPatch.MSF, SCPatch.REG} and len(seg.below) > 1:
    ...
    def map_to_grid(self):
        self.grid_segments: 'Set[Segment]' = copy.deepcopy(self.segments)
